...
import inga from '../assets/img/inga.jpg';
...
import PizzaBlockinga from '../components/PizzaBlockinga';
  ...
  return (
    <div className="container">
      ...
      {status === 'error' ? (
        ...
        <div className="content__items">{status === 'loading' ? skeletons : pizzaItems}<PizzaBlockinga id = '' title='inga' price={15} imageUrl= {inga} sizes={[50, 70]} types={[0]} /></div>
      )}
