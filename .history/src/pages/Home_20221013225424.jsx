...
const Home = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://6343125dba4478d47847e536.mockapi.io/Items?page=${pageCount}&limit=4&${category}&sortBy=${sortBy}&order=${order}${search}`,
      )
      .then((response) => {
  ...
  return (
    <div className="container">
      ...
      <Pagination value={pageCount} onPageChange={(number) => onChangePage(number)} />
    </div>
  );
};
