...
const Search = () => {
  return (
    <div>
        <svg className={styles.icon} xmlns="http://www.w3.org/2000/svg" id="Layer_1" style="enable-background:new 0 0 24 24;" version="1.1" viewBox="0 0 24 24" xml:space="preserve"><style type="text/css">
